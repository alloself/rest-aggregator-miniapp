...
export const designTokens = {
  ...
  colors: {
    ...
    accent: {
      ...
      primaryHover: 'rgba(200, 228, 155, 0.45)', // hover состояние для основного акцента
      primaryActive: 'rgba(200, 228, 155, 0.55)', // active состояние для основного акцента
...
export const tailwindTokens = {
  colors: {
    ...
    'bg-secondary-hover': designTokens.colors.background.secondaryHover,
    'bg-secondary-active': designTokens.colors.background.secondaryActive,
    ...
    'accent-primary-hover': designTokens.colors.accent.primaryHover,
    'accent-primary-active': designTokens.colors.accent.primaryActive,
