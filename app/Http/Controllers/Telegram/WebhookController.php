    ...
    public function handle(Request $request, Restaurant $restaurant)
    {
        ...
        if (is_array($message) && ($message['chat']['type'] ?? '') === 'private') {
            ...
            if ($text === '/start' || str_starts_with($text, '/start ')) {
                ...
                $greeting = "Привет! В этом приложении — всё самое важное о Gretto: меню, фото, адрес, актуальные новости, анонсы событий и бронирование.\n\n"
                    . "Внутри приложения нажмите кнопку Repeat — это знак, что вы к нам вернетесь. И ваши друзья в Telegram увидят, что вам в Gretto действительно понравилось.\n"
